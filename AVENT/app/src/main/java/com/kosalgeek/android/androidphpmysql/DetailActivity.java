...
public class DetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText etName, etTanggal, etImageUrl,etKategori, etDeskrip;
    ImageView ivImage;
    Button btnUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(product != null){
            ...
            etTanggal.setText("" + product.tanggal);
    ...
    public void onClick(View v) {
        ...
        postData.put("txtTanggal", etTanggal.getText().toString());
        ...
        taskUpdate.execute("http://192.168.43.41/avent/update.php");
    }
}
